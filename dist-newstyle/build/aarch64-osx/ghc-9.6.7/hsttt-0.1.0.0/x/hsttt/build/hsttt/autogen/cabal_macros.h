...
/* package hsttt-0.1.0.0 */
#ifndef VERSION_hsttt
#define VERSION_hsttt "0.1.0.0"
#endif /* VERSION_hsttt */
#ifndef MIN_VERSION_hsttt
#define MIN_VERSION_hsttt(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hsttt */
...
#define CURRENT_COMPONENT_ID "hsttt-0.1.0.0-inplace-hsttt"
